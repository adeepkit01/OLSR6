...
#ifndef OLSR6_HEADER_H
#define OLSR6_HEADER_H
 ...
 * \ingroup olsr6
 *
 * The basic layout of any packet in OLSR6 is as follows (omitting IP and
 * UDP headers):
  \verbatim
    0                   1                   2                   3
...
public:
   ...
   */
  void SetOriginatorAddress (Ipv6Address originatorAddress)
  {
   ...
   */
  Ipv6Address GetOriginatorAddress () const
  {
...
private:
  ...
  Ipv6Address m_originatorAddress;  //!< The originator address.
...
public:
  ...
  */
  struct Mid
  {
    std::vector<Ipv6Address> interfaceAddresses;  //!< Interface Address container.
    /**
  ...
  */
  struct Hello
  {
    ...
    struct LinkMessage
    {
      ...
      std::vector<Ipv6Address> neighborInterfaceAddresses;  //!< Neighbor interface address container.
    };
  ...
  struct Tc
  {
    std::vector<Ipv6Address> neighborAddresses; //!< Neighbor address container.
  ...
  struct Hna
  {
    ...
    struct Association
    {
      ...
      Ipv6Prefix mask;       //!< IPv6 netprefix.
    };
